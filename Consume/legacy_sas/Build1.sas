...
*******************************************************************;
FILENAME Cnt 'c:\counts\2015\count15.dat';
*******************************************************************;
** Note: Change DATA count.count90 to;
**                   count.count93 for 1993 Analysis;
*******************************************************************;
DATA tcount.count15; INFILE Cnt missover lrecl=260;
...
**  count.count93 for 1993 Analysis;
*******************************************************************;
PROC FREQ DATA=tcount.count15;
TABLES TOTAL24C YEAR MONTH ROUTE COUNTY ROADTYPE ROADTYPE LOCATION
 STATION LEG end1amc end2amc
 end3amc end4amc end5amc end6amc end7amc end8amc end9amc end10amc
 end11amc end12noc end1pmc end2pmc end3pmc end4pmc end5pmc end6pmc
 end7pmc end8pmc end9pmc end10pmc end11pmc end12nic/missing list;
RUN;
